...
public abstract class MicroService implements Runnable {
    ...
    private ConcurrentHashMap<Class <? extends Message>,Callback> hMapCallBackMessages;
    ...
    public MicroService(String name) {
        this.name = name;
        hMapCallBackMessages=new ConcurrentHashMap<>();
    }
    ...
    protected final <T, E extends Event<T>> void subscribeEvent(Class<E> type, Callback<E> callback) {
        ...
        hMapCallBackMessages.put(type, callback);
    }
    ...
    public final void run() {
        ...
        while (!terminated) {
            try {
                message = m.awaitMessage(this);
                Callback c = hMapCallBackMessages.get(message.getClass());
                c.call(message);
            } catch (InterruptedException e) {
                e.printStackTrace();
            }
        ...
        m.unregister(this);
        System.out.println(name+" is terminating");
    }
